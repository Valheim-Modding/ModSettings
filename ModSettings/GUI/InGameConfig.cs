...
namespace ModSettings.GUI
{
    ...
    internal static class InGameConfig
    {
        ...
        /// </summary>
        private const string MenuToken = "$modsettings";

        /// <summary>
        ///     Text of the Cancel button
        /// </summary>
        private const string CancelToken = "$modsettings_cancel";

        /// <summary>
        ///     Text of the OK button
        /// </summary>
        private const string OKToken = "$modsettings_ok";

        /// <summary>
        ///     Text of the keybind dialogue
        /// </summary>
        private const string KeybindToken = "$modsettings_keybind";
        ...
        private static void LoadModSettingsPrefab()
        {
            ...
            PrefabManager.Instance.AddPrefab(SettingsPrefab);
            bundle.Unload(false);
        ...
        private static void CreatePlugin(ModSettings settings, KeyValuePair<string, BaseUnityPlugin> mod)
        {
                         ...
                         .GroupBy(x => x.Key.Section))
            {
                ...
                foreach (var entry in kv.OrderByDescending(x =>
                {
                    ...
                    return attributes.Order ?? int.MaxValue;
                ...
                }).ThenBy(x => x.Key.Key))
                {
                    ...
                    var entryAttributes = new ConfigurationManagerAttributes();
                    entryAttributes.SetFromAttributes(entry.Value.Description?.Tags);
